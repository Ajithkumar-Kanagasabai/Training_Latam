            ...
            <section className="px-4 md:px-20 mt-8 bg-white grid grid-cols-1 lg:grid-cols-2 items-center">
                <div className="flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center">
                        <h1 className="sm:hidden px-[10%] text-white text-lg font-bold text-center" style={{ lineHeight: "30px" }}>The Future Of Technology Is In Latam. Learn The Tools With Us, Boost Your Skills And Build Your Dreams!</h1>
                        <h1 className="hidden sm:flex md:hidden px-[10%] text-white text-2xl font-bold text-center" style={{ lineHeight: "40px" }}>The Future Of Technology Is In Latam. Learn The Tools With Us, Boost Your Skills And Build Your Dreams!</h1>
                        <h1 className="hidden md:flex lg:hidden px-[10%] text-white text-3xl font-bold text-center" style={{ lineHeight: "50px" }}>The Future Of Technology Is In Latam. Learn The Tools With Us, Boost Your Skills And Build Your Dreams!</h1>
                        <h1 className="hidden lg:flex px-[10%] text-white text-4xl font-bold text-center" style={{ lineHeight: "50px" }}>The Future Of Technology Is In Latam. Learn The Tools With Us, Boost Your Skills And Build Your Dreams!</h1>
                    </div>
                </div>
            ...
            <section className="px-4 md:px-20 mt-8 bg-white grid grid-cols-1 lg:grid-cols-2 items-center">
                <div className='lg:px-8'>
                    ...
                    <ul className="list-inside text-gray-600 space-y-2">
                        <li>
                            <span className="font-bold">Full Stack Development:</span> Master the art of coding and software engineering.
                        </li>
                        <li>
                            <span className="font-bold">Data Science and Analytics:</span> Unlock the potential of data with cutting-edge techniques.
                        </li>
                        <li>
                            <span className="font-bold">DevOps and IT Management:</span> Streamline operations and improve efficiency.
                        </li>
                    </ul>
                </div>
