        ...
        <div className="bg-white py-12 px-4 md:px-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 text-center">
                <div className="flex flex-col items-center">
                    <Image src={Icon1} alt="Tailored for Latin American Talent" className="w-16 h-16 mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <Image src={Icon2} alt="Expert Instructors" className="w-16 h-16 mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <Image src={Icon3} alt="Hands-On Learning" className="w-16 h-16 mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <Image src={Icon4} alt="Career Support" className="w-16 h-16 mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <Image src={Icon5} alt="Global Community" className="w-16 h-16 mb-4" />
            ...
            <p className="text-gray-600 mt-12 text-center max-w-4xl mx-auto">
